...
=======
const static name system_account_name    { N(zswhq) };
const static name null_account_name      { N(zswhq.null) };
const static name producers_account_name { N(zswhq.prods) };
...
=======
const static name eosio_auth_scope       { N(zswhq.auth) };
const static name eosio_all_scope        { N(zswhq.all) };

const static name active_name     { N(active) };
const static name owner_name      { N(owner) };
const static name eosio_any_name  { N(zswhq.any) };
const static name eosio_code_name { N(zswhq.code) };
>>>>>>> 1926c9588e98187e7666c14ab94ac800a6ca84d7

const static int      block_interval_ms = 500;
const static int      block_interval_us = block_interval_ms*1000;
const static uint64_t block_timestamp_epoch = 946684800000ll; // epoch is year 2000.
const static uint32_t genesis_num_supported_key_types = 4;
