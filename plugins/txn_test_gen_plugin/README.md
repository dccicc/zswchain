...
$ ./cleos wallet import --private-key 5KUhXKkRG9hST5x579mU26zAimAaRFWpxC3jHZoYqoBt9GZxdcJ
$ ./cleos set contract eosio ~/eos/build.release/contracts/eosio.bios/ 
```

### Initialize the accounts txn_test_gen_plugin uses
```bash
$ curl --data-binary '["eosio", "5KUhXKkRG9hST5x579mU26zAimAaRFWpxC3jHZoYqoBt9GZxdcJ"]' http://127.0.0.1:8888/v1/txn_test_gen/create_test_accounts
```
