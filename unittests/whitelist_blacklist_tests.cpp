...
<<<<<<< HEAD
         ...
         chain->push_action( "eosio.token"_n, "issue"_n, "eosio.token"_n, mvo()
              ( "to", "eosio.token" )
=======
         chain->create_accounts({N(zswhq.token), N(alice), N(bob), N(charlie)});
         chain->set_code(N(zswhq.token), contracts::eosio_token_wasm() );
         chain->set_abi(N(zswhq.token), contracts::eosio_token_abi().data() );
         chain->push_action( N(zswhq.token), N(create), N(zswhq.token), mvo()
              ( "issuer", "zswhq.token" )
              ( "maximum_supply", "1000000.00 TOK" )
         );
         chain->push_action( N(zswhq.token), N(issue), N(zswhq.token), mvo()
              ( "to", "zswhq.token" )
...
=======
         return chain->push_action( N(zswhq.token), N(transfer), from, mvo()
>>>>>>> 1926c9588e98187e7666c14ab94ac800a6ca84d7
            ( "from", from )
            ( "to", to )
            ( "quantity", quantity )
...
=======
   test.actor_whitelist = {config::system_account_name, N(zswhq.token), N(alice)};
   test.init();

   test.transfer( N(zswhq.token), N(alice), "1000.00 TOK" );
>>>>>>> 1926c9588e98187e7666c14ab94ac800a6ca84d7
...
=======
   test.contract_whitelist = {config::system_account_name, N(zswhq.token), N(bob)};
   test.init();

   test.transfer( N(zswhq.token), N(alice), "1000.00 TOK" );

   test.transfer( N(alice), N(zswhq.token) );
>>>>>>> 1926c9588e98187e7666c14ab94ac800a6ca84d7
...
<<<<<<< HEAD
   ...
   test.transfer( "eosio.token"_n, "alice"_n, "1000.00 TOK" );
=======
   test.contract_whitelist = {config::system_account_name, N(zswhq.token), N(bob), N(charlie)};
...
=======
   tester1.chain->push_action( N(zswhq), N(updateauth), N(alice), mvo()
>>>>>>> 1926c9588e98187e7666c14ab94ac800a6ca84d7
      ( "account", "alice" )
      ( "permission", "active" )
      ( "parent", "owner" )
...
=======
   tester1.chain->push_action( N(zswhq), N(updateauth), N(bob), mvo()
>>>>>>> 1926c9588e98187e7666c14ab94ac800a6ca84d7
      ( "account", "bob" )
      ( "permission", "active" )
      ( "parent", "owner" )
...
=======
   tester1.chain->push_action( N(zswhq), N(updateauth), N(charlie), mvo()
>>>>>>> 1926c9588e98187e7666c14ab94ac800a6ca84d7
      ( "account", "charlie" )
      ( "permission", "active" )
      ( "parent", "owner" )
...
=======
      if( act.account == N(zswhq) && act.name == N(onblock) ) return;
>>>>>>> 1926c9588e98187e7666c14ab94ac800a6ca84d7
